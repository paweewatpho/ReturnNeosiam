...
const Operations: React.FC<OperationsProps> = ({ initialData, onClearInitialData }) => {
  ...
  const handleGenerateDoc = () => {
      ...
      // *** แก้ไข: เพิ่มการแจ้งเตือนหากไม่มีการเลือกรายการ ***
      if (selectionItems.length > 0 && selectedList.length === 0) {
          alert("กรุณาเลือกรายการสินค้าอย่างน้อย 1 รายการเพื่อสร้างเอกสาร");
          return;
      }
      if (selectionItems.length === 0) {
          alert("ไม่พบรายการสินค้าที่เลือกไว้ในสถานะนี้ กรุณาตรวจสอบ");
          return;
      }
      // **************************************************
